                            ...
                            Positioned(
                              ...
                              child: GestureDetector(
                                child: Container(
                                  ...
                                  child: Icon(Icons.camera_alt_rounded, size: 18.sp, color: Colors.black),
                                ),
                              ),
                            ),
                          ],
                      ...
                      onTap: () {
                        showDialog(
                          ...
                          builder: (_) => AlertDialog(
                            ...
                            title: Text("Confirm Logout", style: GoogleFonts.montserrat(color: Colors.black)),
                            content: Text(
        ...
        child: Row(
          children: [
            CircleAvatar(
              radius: 26.r,
              backgroundColor: Colors.grey.shade100,
              child: Icon(Icons.sports_handball_rounded, color: Colors.grey.shade500, size: 32.sp),
            ),
            16.width,
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(name, style: GoogleFonts.poppins(fontSize: 13.sp, fontWeight: FontWeight.w600, color: Colors.black)),
                  4.height,
                  Text(subtitle, style: GoogleFonts.poppins(fontSize: 12.sp, color: textSecondary)),
                ],
              ),
            ),
