...
class ClubAdminAddCoachScreen extends StatefulWidget {
  ...
  @override
  State<ClubAdminAddCoachScreen> createState() => _ClubAdminAddCoachScreenState();
}
  ...
  Widget _step1() {
    return Column(
      ...
      children: [
        ...
        _formField('Username *', _usernameCtrl, Icons.account_circle_rounded,
        ...
        _formField('Years of Experience', _experienceCtrl, Icons.timeline_rounded,
            hint: 'e.g., 8', keyboardType: TextInputType.number, required: false),
        12.height,

        _formField('Certification', _certificationCtrl, Icons.workspace_premium_rounded,
            hint: 'e.g., AIFF Level B', required: false),
        12.height,

        _formField('Bio', _bioCtrl, Icons.description_rounded,
          ...
          children: _specializations.map((spec) {
            ...
            return ChoiceChip(
              ...
              shape: RoundedRectangleBorder(
                ...
                side: BorderSide(color: selected ? accentGreen : Colors.grey.shade300),
              ),
            );
          }).toList(),
        ),
      ...
      children: [
        ...
        Wrap(
          ...
          children: _availableGroups.map((group) {
            ...
            return FilterChip(
              label: Text(group, style: GoogleFonts.poppins(fontSize: 12.sp,color: Colors.grey)),
              selected: selected,
              onSelected: (sel) {
                setState(() {
                  if (sel) {
            ...
            children: [
              Text('Review Summary',
                  style: GoogleFonts.montserrat(
                      ...
                      color: Colors.black)),
              12.height,
              _summaryRow('Username', _usernameCtrl.text.isNotEmpty ? _usernameCtrl.text : '—'),
              _summaryRow('Specialization', _selectedSpecialization ?? '—'),
              _summaryRow('Groups', _selectedGroups.isNotEmpty ? _selectedGroups.join(', ') : '—'),
              _summaryRow('Experience', _experienceCtrl.text.isNotEmpty ? '${_experienceCtrl.text} years' : '—'),
            ],
          ),
        ),
      ],
