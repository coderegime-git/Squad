        ...
        builder: (ctx, setSheet) => Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              20.height,
              _sheetField('Sub-group Name *', nameCtrl, Icons.group_work_rounded,
                  hint: 'e.g., Under 14 A'),
              12.height,
              _sheetField(
                ...
                child: ElevatedButton(
                  onPressed: isLoading
                    ...
                    if (success) {
                      Navigator.pop(ctx);
                      AppUI.success(
                          context, 'Sub-group "${nameCtrl.text}" created!');
                      _refresh();
                    } else {
                      AppUI.error(
                          context, 'Failed to create sub-group. Try again.');
                    }
                  },
                ...
                child: ElevatedButton(
                  onPressed: isLoading
                    ...
                    if (success) {
                      ...
                      AppUI.error(
                          context, 'Failed to update sub-group. Try again.');
                    }
                  },
                  style: ElevatedButton.styleFrom(
                    backgroundColor: accentGreen,
  ...
  Future<void> _confirmDelete(SubGroupData subGroup) async {
    ...
    if (confirmed == true) {
      ...
      final success = await _apiService.deleteSubGroup(
          widget.group.groupId, subGroup.subGroupId);
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      4.width,
                      Flexible(
                        child: Text('Tap to manage teams',
                            style: GoogleFonts.poppins(
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                      color: Colors.blue.withOpacity(0.12),
                      borderRadius: BorderRadius.circular(20.r)),
                  child: Text('ID: ${subGroup.subGroupId}',
                      style: GoogleFonts.poppins(
                          fontSize: 10.sp,
                          color: Colors.blue,
                          fontWeight: FontWeight.w600)),
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(20.r)),
                    child: Text('Group ID: ${widget.group.groupId}',
                        style: GoogleFonts.poppins(
                            fontSize: 10.sp,
                            color: accentGreen,
                            fontWeight: FontWeight.w700)),
